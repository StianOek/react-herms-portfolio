...
import zeiptGetStartedPage from "./img/zeipt2.jpg";
import zeiptLandingPage from "./img/zeipt.jpg";
    ...
    desc: [
      {
        ...
        desc:
          "I was lucky to get the job for an internship position with Zeipt As at the end of my first semester. the first three months, Zeipt team wanted me to build myself a portfolio with a few tools requirments, which were React.js including all libraries and framworks that followed. After three months i had the portfolio up and running. In fact its the portfolio you are visiting right now.",
        descTwo:
          "Time passed by, and after three months i get to work on production material. ",
        link: "https://zeiptlanding.stianhermansen.com",
        zeiptLandingPage: zeiptLandingPage,
        zeiptGetStartedPage: zeiptGetStartedPage,
      },
    ],
  },
